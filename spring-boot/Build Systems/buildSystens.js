...
dependencies in the build configuration file. Spring Boot automatically configures
those dependencies version based on the release. Remember that when you upgrade
...
your configuration file. However, the Spring Boot team highly recommends that it
is not needed to specify the version for dependency.
...
Then for other starter dependencies, we do not need to specify the Spring Boot
...
Gradle Dependency
We can import the Spring Boot Starter dependencies directly into build.gradle
file. We do not need Spring Boot Starter Parent dependency like Maven for Gradle.
...
Similarly, in Gradle, we need not specify the Spring Boot Version number for
dependencies. Spring Boot automatically configures the dependecny based on
the version.
